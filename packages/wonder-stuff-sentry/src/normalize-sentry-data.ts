 ...
 * @returns {SentryData}
 */
export function normalizeSentryData(options: KindErrorDataOptions, data?: Readonly<Partial<SentryData>> | null): SentryData {
    ...
    const usedReservedKeys: Array<string> = [];
                        ...
                        contexts: {
                            "Invalid Sentry Data": {
                                ...
                                contexts_with_reserved_properties:
                                    (reservedPropertyContexts as any),
                            },
                        },
                    },
                },
