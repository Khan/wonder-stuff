import {errorsFromError, Order, getKindFromError} from "@khanacademy/wonder-stuff-core";
 ...
 */
export const collateSentryData = (options: KindErrorDataOptions, error: Error): Readonly<SentryData> => {
...
// @ts-expect-error - TS2542 - Index signature in type '{ readonly [x: string]: string; }' only permits reading.
