...
describe("#normalizeSentryData", () => {
    ...
    it("should return the validated sentry data", () => {
        ...
        // Act
        // @ts-expect-error [FEI-5011] - TS2345 - Argument of type '{ readonly tags: { readonly tag1: "tag1Value"; readonly tag2: "tag2Value"; }; readonly contexts: { readonly contextOne: { readonly iAm: "a context"; }; readonly contextTwo: { readonly iAmAlso: "a context"; }; }; readonly fingerprint: readonly [...]; }' is not assignable to parameter of type 'Readonly<Partial<SentryData>>'.
