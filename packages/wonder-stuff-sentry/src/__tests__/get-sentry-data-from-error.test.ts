...
// @ts-expect-error - TS2322 - Type '{ readonly tags: { readonly tag1: "tagValue1"; }; readonly contexts: { readonly context1: { readonly context1Key1: "context1Value1"; }; }; readonly fingerprint: readonly ["fingerprint1"]; }' is not assignable to type 'Partial<SentryData>'.
            sentryData,
        });
