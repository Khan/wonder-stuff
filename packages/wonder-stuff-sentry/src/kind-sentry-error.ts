...
export class KindSentryError extends KindError {
    ...
    get sentryData(): Readonly<SentryData> {
        ...
        //     we need.
// @ts-expect-error - TS2322 - Type 'MetadataPrimitive | Metadata | MetadataArray<MetadataPrimitive | Metadata>' is not assignable to type 'Readonly<SentryData>'. | TS2533 - Object is possibly 'null' or 'undefined'.
