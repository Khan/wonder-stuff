...
export class ErrorInfo {
    ...
    readonly _stackFrames: ReadonlyArray<string>;
     ...
     *      stackShared1
     */
    static fromConsequenceAndCause(consequence: ErrorInfo, cause: ErrorInfo): ErrorInfo {
        ...
        // share.
        const combinedStackFrames: Array<string> = [];
     ...
     * error.
     */
    static normalize(error: Error, stripFrames: number = 0, minimumFrameCount: number = 1): ErrorInfo {
        if (process.env.NODE_ENV !== "production") {
            // Verify our arguments.
