...
// @ts-expect-error - TS2345 - Argument of type 'null' is not assignable to parameter of type 'ErrorInfo'.
    ...
    describe("#normalize", () => {
        describe("when not built for production", () => {
            it("should throw if error is not an Error", () => {
                // Arrange
// @ts-expect-error - TS2739 - Type '{}' is missing the following properties from type 'Error': name, message
                const error: Error = {};
...
// @ts-expect-error - TS2769 - No overload matches this call. | TS2345 - Argument of type 'string' is not assignable to parameter of type 'never'.
