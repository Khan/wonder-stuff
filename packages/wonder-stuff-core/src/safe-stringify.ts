...
const getOptionsFromArg = (defaultValueOrOptions: string | SafeStringifyOptions): SafeStringifyOptions => {
    if (
...
export const safeStringify: safeStringifyFn = <T>(value: T, defaultValueOrOptions: string | SafeStringifyOptions = ""): string => {
