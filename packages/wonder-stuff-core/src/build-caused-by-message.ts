 ...
 */
export const buildCausedByMessage = (consequence?: string | null, cause?: string | null): string => {
    const messageOrDefault = (message?: string | null): string => message?.trim() || "(empty message)";
