...
// @ts-expect-error - TS2322 - Type '100' is not assignable to type '5 | undefined'.
...
// @ts-expect-error - TS2322 - Type '{ readonly x: 20; readonly y: 30; }' is not assignable to type '{ readonly x: 5; readonly y: 10; }'.
            const data = dataFactory({p});
// @ts-expect-error - TS2540 - Cannot assign to 'x' because it is a read-only property.
            data.p.x = 100;
