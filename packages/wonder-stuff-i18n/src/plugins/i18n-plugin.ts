...
export default class I18nPlugin {
    ...
    apply(compiler: any) {
// @ts-expect-error - TS7006 - Parameter 'options' implicitly has an 'any' type. | TS7006 - Parameter 'callback' implicitly has an 'any' type.
     ...
     */
    async getTranslatedStrings(locales: Array<string>): Promise<TranslatedStrings> {
