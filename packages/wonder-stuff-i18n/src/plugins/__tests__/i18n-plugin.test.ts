...
// @ts-expect-error - TS2345 - Argument of type '{}' is not assignable to parameter of type 'Options'.
        ...
        it("errors when there is no getI18nStrings", () => {
            ...
            // Assert
            expect(() => {
// @ts-expect-error - TS2345 - Argument of type '{ locales: never[]; }' is not assignable to parameter of type 'Options'.
...
// @ts-expect-error - TS7053 - Element implicitly has an 'any' type because expression of type 'string' can't be used to index type '{ readonly "test.deadbeefc0ffeec0ffee": { readonly source: () => string; readonly size: () => number; }; readonly "test-pluralonly.deadbeefc0ffeec0ffe2": { readonly source: () => string; readonly size: () => number; }; }'.
...
// @ts-expect-error - TS7053 - Element implicitly has an 'any' type because expression of type 'string' can't be used to index type '{ readonly "test.deadbeefc0ffeec0ffee": { readonly source: () => string; readonly size: () => number; }; readonly "test-pluralonly.deadbeefc0ffeec0ffe2": { readonly source: () => string; readonly size: () => number; }; }'.
        ...
        it("copies non-JS files, instead of translating them", () => {
            ...
            for (const assetName of Object.keys(assets)) {
                stringAssets[assetName] = {
// @ts-expect-error - TS7053 - Element implicitly has an 'any' type because expression of type 'string' can't be used to index type '{ readonly "test.css": { readonly source: () => string; readonly size: () => number; }; readonly "font.woff2": { readonly source: () => string; readonly size: () => number; }; }'.
                    source: assets[assetName].source(),
// @ts-expect-error - TS7053 - Element implicitly has an 'any' type because expression of type 'string' can't be used to index type '{ readonly "test.css": { readonly source: () => string; readonly size: () => number; }; readonly "font.woff2": { readonly source: () => string; readonly size: () => number; }; }'.
                    size: assets[assetName].size(),
                };
    ...
    describe("localizeManifests", () => {
        it("can localize manifest and HTML files", () => {
            ...
            for (const assetName of Object.keys(assets)) {
                stringAssets[assetName] = {
// @ts-expect-error - TS7053 - Element implicitly has an 'any' type because expression of type 'string' can't be used to index type '{ readonly "test.deadbeefc0ffeec0ffee": { readonly source: () => string; readonly size: () => number; }; readonly "runtime.deadbeefc0ffeec0ffe2": { readonly source: () => string; readonly size: () => number; }; ... 6 more ...; readonly "../pages/pt/page-1234.html": { ...; }; }'.
                    source: assets[assetName].source(),
// @ts-expect-error - TS7053 - Element implicitly has an 'any' type because expression of type 'string' can't be used to index type '{ readonly "test.deadbeefc0ffeec0ffee": { readonly source: () => string; readonly size: () => number; }; readonly "runtime.deadbeefc0ffeec0ffe2": { readonly source: () => string; readonly size: () => number; }; ... 6 more ...; readonly "../pages/pt/page-1234.html": { ...; }; }'.
                    size: assets[assetName].size(),
                };
