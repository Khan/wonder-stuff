import {extractHashFromFileName, localizeString, localizeFile, hashFileContents} from "../localize-file";
...
describe("localizeFile", () => {
    it("localizes the runtime file contents and updates the hashMap", () => {
        ...
        const locale = "es";
        const hashMap = {"2e083afe95f447481cad": "4e083afe95f447481cad"} as const;
        const getLocalePath = (locale: string) => `/prod/${locale}/`;
