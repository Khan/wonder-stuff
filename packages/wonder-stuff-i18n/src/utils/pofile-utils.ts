...
export const buildPoItem = (
    ...
    // @ts-expect-error [FEI-5011] - TS2322 - Type 'Item' is not assignable to type 'POItem'.
...
export const getPOTFileStringFromFiles = (files: Array<string>): string => {
    ...
    // @ts-expect-error [FEI-5011] - TS2740 - Type 'Map<string, POItem>' is missing the following properties from type 'Item[]': length, pop, push, concat, and 24 more.
