...
// @ts-expect-error - TS2322 - Type 'Item' is not assignable to type 'POItem'.
 ...
 */
export const getFilesToExtractFrom = (userSpecifiedFiles: Array<string>): Array<string> => {
...
// @ts-expect-error - TS2740 - Type 'Map<string, POItem>' is missing the following properties from type 'Item[]': length, pop, push, concat, and 24 more.
