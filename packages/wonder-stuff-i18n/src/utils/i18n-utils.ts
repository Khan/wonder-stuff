...
// @ts-expect-error - TS7016 - Could not find a declaration file for module 'ancesdir'. '/Users/kevinbarabash/khan/wonder-stuff/node_modules/ancesdir/dist/index.js' implicitly has an 'any' type.
 ...
 */
export const getIgnoreGlobs = (ignoreFile: string = ".i18nignore"): Array<string> => {
    try {
 ...
 *  code string
 */
export const getI18nStringsFromString = (textString: string): Array<ExtractedString> => {
