    ...
    describe("in production", () => {
        it("should add the logging-winston middleware", async () => {
            ...
            jest.spyOn(
                ...
                "makeMiddleware",
                // @ts-expect-error [FEI-5011] - TS2345 - Argument of type 'string' is not assignable to parameter of type 'Promise<(req: ServerRequest, res: ServerResponse<IncomingMessage>, next: Function) => void>'.
