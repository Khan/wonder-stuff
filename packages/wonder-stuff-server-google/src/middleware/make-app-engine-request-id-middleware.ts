 ...
 */
export function makeAppEngineRequestIDMiddleware<TReq extends RequestWithLog<Request>, TRes extends Response>(defaultLogger: Logger): Middleware<TReq, TRes> {
    return <TReq extends RequestWithLog<Request>, TRes extends Response>(req: TReq, res: TRes, next: NextFunction): void => {
