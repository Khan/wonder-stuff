...
describe("#trace", () => {
    it.each([[""], [null], [undefined]])(
        ...
        (testPoint: any) => {
            ...
            // @ts-expect-error [FEI-5011] - TS2345 - Argument of type '{ name: string; version: string; }' is not assignable to parameter of type 'AppEngineInfo'.
        ...
        describe("#end", () => {
            it("should stop the profile timer", () => {
                ...
                jest.spyOn(process, "memoryUsage")
                    .mockReturnValueOnce({
                        // @ts-expect-error [FEI-5011] - TS2345 - Argument of type '{ someMemoryStuff: number; }' is not assignable to parameter of type 'MemoryUsage'.
