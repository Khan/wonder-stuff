...
describe("get-logger", () => {
    describe("#getLogger", () => {
        ...
        it("should return the root logger when the request has no log", async () => {
            ...
            // Act
// @ts-expect-error - TS2345 - Argument of type '{}' is not assignable to parameter of type 'RequestWithLog<Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>>'.
            const result = getLogger({});
        ...
        it("should return the request logger when the request has a log", async () => {
            ...
            // Act
// @ts-expect-error - TS2345 - Argument of type '{ readonly log: Record<string, any>; }' is not assignable to parameter of type 'RequestWithLog<Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>>'.
