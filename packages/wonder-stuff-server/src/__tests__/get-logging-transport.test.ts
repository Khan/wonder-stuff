...
// @ts-expect-error - TS2345 - Argument of type 'string' is not assignable to parameter of type 'never'. | TS2339 - Property 'mockReturnValue' does not exist on type 'never'.
...
// @ts-expect-error - TS2345 - Argument of type 'string' is not assignable to parameter of type 'never'. | TS2339 - Property 'mockReturnValue' does not exist on type 'never'.
    ...
    describe("unrecognised runtime mode", () => {
        it("should write to a stream", () => {
            ...
            // Act
// @ts-expect-error - TS2345 - Argument of type '"MADE UP RUNTIME MODE"' is not assignable to parameter of type '"production" | "test" | "development"'.
