...
// @ts-expect-error - TS2345 - Argument of type '{ debug: jest.Mock<any, any, any>; }' is not assignable to parameter of type 'Logger'.
...
// @ts-expect-error - TS2339 - Property 'splat' does not exist on type 'SpyInstance<FormatWrap, [transform: TransformFunction], any>'.
            winstonFormatSpy.splat = jest.fn();
// @ts-expect-error - TS2339 - Property 'printf' does not exist on type 'SpyInstance<FormatWrap, [transform: TransformFunction], any>'.
            winstonFormatSpy.printf = jest.fn();
// @ts-expect-error - TS2339 - Property 'combine' does not exist on type 'SpyInstance<FormatWrap, [transform: TransformFunction], any>'.
