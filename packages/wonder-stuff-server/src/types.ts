// @ts-expect-error - TS2305 - Module '"winston"' has no exported member 'NpmLogLevels'. | TS2724 - '"winston"' has no exported member named 'Info'. Did you mean 'info'? | TS2724 - '"winston"' has no exported member named 'Transport'. Did you mean 'transport'?
import type {NpmLogLevels, Logger as WinstonLogger, Info as WinstonInfo, Transport} from "winston";
 ...
 */
// @ts-expect-error - TS2315 - Type 'Logger' is not generic.
