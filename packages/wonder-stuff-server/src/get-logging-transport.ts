...
// @ts-expect-error - TS2724 - '"winston"' has no exported member named 'Transport'. Did you mean 'transport'? | TS2724 - '"winston"' has no exported member named 'Format'. Did you mean 'format'?
 ...
 */
const getFormatters = (mode: typeof Runtime[keyof typeof Runtime]): Format => {
 ...
 */
export const getLoggingTransport = (mode: typeof Runtime[keyof typeof Runtime], logLevel: LogLevel): Transport => {
    switch (mode) {
        /**
